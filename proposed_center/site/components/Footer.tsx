    ...
    <footer className="border-t border-[#e2e0dc] bg-[#f7f6f3] mt-20">
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="md:col-span-1">
          <p className="text-[11px] uppercase tracking-[0.15em] text-[#6b6b6b] mb-1">Columbia University Teachers College</p>
          <p className="text-[15px] font-semibold text-[#002868]">Center for Technology Management</p>
        ...
        <nav className="flex flex-col gap-2.5 text-sm text-[#6b6b6b]">
          ...
          <Link href="/leadership" className="hover:text-[#002868] transition-colors">Leadership</Link>
          <Link href="/experience" className="hover:text-[#002868] transition-colors">Student Experience</Link>
        </nav>
